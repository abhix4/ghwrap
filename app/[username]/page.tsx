...
export default function UserPage() {
  ...
  const tabs = [
    ...
    <TopRepositories repositories={userData?.wrapped?.topRepos} />,
    <Streak longestStreak={userData?.wrapped.stats.longestStreak} />,
  ...
  return (
    <>
      ...
      <div
        className="flex h-screen w-full flex-col items-center gap-12 overflow-hidden bg-[#222222] p-4 px-40 md:hidden"
        tabIndex={0}
        onKeyDown={(e) => {
          if (e.key === "Enter" || e.key === "ArrowRight") setIndex((prev) => prev + 1);
          else if (e.key === "ArrowLeft") setIndex((prev) => prev - 1);
