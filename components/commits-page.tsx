...
export default function CommitsPage({ totalCommits }: { totalCommits: string }) {
  return (
    <div className="relative h-[80%] max-w-3xl md:min-w-3xl rounded-2xl bg-[#F2F3F2] p-6 md:p-12">
      ...
      <p className="z-10 text-center text-4xl  md:text-6xl font-medium text-[#FF694D]">
        Some call it grinding. <br />
        You call it fun.
      </p>
      <p className="z-10 mt-16 text-center text-3xl md:text-4xl font-semibold text-[#FF694D]">
